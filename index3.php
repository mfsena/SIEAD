					...
					<div id="middlepic">
						<div id="contenttxt">
									<table border="1" cellpadding="0" cellspacing="0" style="text-align: left; height: 40px;">
										<tbody>
													<tr>
														<td style="vertical-align: central; size:24px; text-align: center; background-color: rgb(40,88,133); color: white;"><strong>ERRO!</strong></td>
												</tr>
									  </tbody>
								</table>
									<h2>&nbsp;</h2>
									<div id="formWrap"></div>
									<br>
									<h2 align="center">ACESSO N&Atilde;O AUTORIZADO!<br>
						  </h2>
									<h2 align="center">P&Aacute;GINA EXCLUSIVA PARA PROFESSORES E ADMINISTRADORES <br>
						            </h2>
									<p><br>
											</b></p>
									<p>&nbsp;</p>
